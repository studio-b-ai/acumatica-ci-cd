...
class TestPOCustomFields:
    ...
    def test_po_screen_loads_no_errors(self, acumatica_screen):
    ...
    def test_po_header_custom_fields_visible(self, acumatica_screen):
        ...
        fields = screen.find_fields(["UsrExpArrivalDate"])
    ...
    def test_po_line_custom_fields_visible(self, acumatica_screen):
